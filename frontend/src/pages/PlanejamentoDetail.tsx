      ...
      {['revisao', 'aprovado', 'ajuste_solicitado'].includes(planejamento.status) && (
        <>
          ...
          <div className="mb-6 flex flex-wrap gap-3">
            ...
            <a
              href={`${API_URL}/api/planejamentos/${id}/download-docx`}
              className="inline-flex items-center gap-2 px-4 py-2 border border-secondary/30 text-secondary rounded-lg hover:bg-secondary/5 transition-colors font-medium text-sm"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
                  d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
